...
class OsmAbbrParser():
    ...
    def __init__(self):
        ...
        self.street_types_kw, self.street_types = self.load_replace_csv('street_abbreviations/street_types.csv')
        self.dir_types_kw,    self.dir_types    = self.load_replace_csv('street_abbreviations/dir_types.csv')
        self.str_replace_kw,  self.str_replace  = self.load_replace_csv('street_abbreviations/string_replace.csv')
        self.str_ignore_kw,   self.str_ignore   = self.load_replace_csv('street_abbreviations/string_ignore_replace.csv')
